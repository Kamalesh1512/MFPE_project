				...
				<div align="center">
					<div class="card"
						...
						<div class="card-body">
							...
							<form:form action="adminreg" method="post" modelAttribute="admin"
								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<form:input path="adminId" class="form-control input-sm"
								...
								<div class="form-group">
									...
									<div>
										<form:select path="secretquestion1" class="form-controll">
											...
											<option value="In which month you born?">In which
												month you born?</option>
								...
								<div class="form-group">
									...
									<div>
										<form:select path="secretquestion3" class="form-controll">
											...
											<option value="what is your favorite comic?">what is
												your favorite comic?</option>
							...
							<span class="signup">Do you have Account?</span><a
								href="adminlogin" class="signupbtn">Login</a>
