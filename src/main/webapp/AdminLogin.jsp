	...
	<div class="container-fluid">
		...
		<div class="row mainsection">
			<div class="col-sm">
				...
				<div align="center">
					<div class="card"
						style="width: 18rem; margin-top: 30px; border-radius: 10px;">

						<div class="card-body">
							<h5 class="card-title">Admin Login</h5>
							<form:form action="loginverify" method="post"
								modelAttribute="adminlogin" onsubmit="return loginvalidate()">
							...
							<span class="signup">Don't have an Account?</span><a href="admin"
								class="signupbtn">Register</a>
