...
<body>
	...
	<div class="formdata3">
		<div align="center">
			<form:form onsubmit="return validate()" action="forgotpwd1"
				method="post" modelAttribute="name1">
				<table>
					<tr>
						<td>UserID:</td>
					...
					<tr>
						...
						<td><form:select path="qstn3" id="qstn3" class="select-box">
								...
								<option value="What is your hometown?">What is your
									hometown?</option>
								<option
									value="In what town or city did you meet your spouse/partner?">In
									what town or city did you meet your spouse/partner?</option>
							</form:select></td>
					</tr>
					<tr>
			...
			<br>
			<br> ${message } <br>
			<br> Want to login?<a href="adminlogin">Click here</a>
